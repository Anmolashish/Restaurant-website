...
$sql="insert into signup(first_name,mobile,email,password)values('$first_name','$mobile','$email','$password')";
...
<div class="row" style="width:362px">
  ...
  <div class="col-6" style="border-left: 1px solid black; background-color:rgba(0, 0, 0, 0.2); margin-top:-24px; height:50px; border-radius:0px 25px 0px 10px">
    <a href="login.php" class="an"><p class="an" style="margin-top:10px;">Log in</p></a>
  </div>
</div>
<form method="POST">
  <br>
...
<input type="number" name="mobile" placeholder="Mobile Number*" ><br>
<input type="email" name="email" placeholder="Email Id (Optional)" ><br>
